...
parser.add_argument('--checkpoint_path', default='./checkpoint_no_attn_four_classes/checkpoint_grid_motion/model_best.pth.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
...
parser.add_argument('--spatial', default=False, type=bool, metavar='N', help='whether spatial feature')
parser.add_argument('--output_path', default='', type=str, metavar='PATH', help='')
...
def main():
    ...
    #path_prefix = '/home/candice/Documents/end-to-end-two-stream/two-stream-action-recognition-icehockey/for_fusion_no_attn_four_classes_motion'
