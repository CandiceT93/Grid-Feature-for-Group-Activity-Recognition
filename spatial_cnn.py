...
parser.add_argument('--checkpoint_path', default='./checkpoint_spatial_new', type=str, metavar='PATH', help='path for saving checkpoint')
...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        #build model
        self.model = resnet101(pretrained = arg.pretrained, channel=3, num_classes=arg.num_classes).cuda()
